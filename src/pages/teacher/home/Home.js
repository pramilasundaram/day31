...
import { FaEdit, FaTrash, FaSort, FaList } from 'react-icons/fa';
...
import { DELETE_TEACHER } from '../../../components/contextProvider/Action.type';
            ...
            >
              ...
              <div className="search_add mt-4 d-flex justify-content-between">
                ...
                <div className="add_btn">
                  <Button color="warning" onClick={() => { nav("/createteacher") }}>
                    Add user
                  </Button>
                </div>
              </div>
